...
Therefore, we propose \Cref{th:opt_s} for transforming \eqref{eq:def}, and the proof is provided in \Cref{proof:opt_s}.
...
The proof of \Cref{th:gamma_c} is available at \Cref{proof:gamma_c}.
...
The proof of \Cref{th:trans} is provided in \Cref{proof:trans}.
...
\subsection{Proof of \Cref{th:opt_s}}\label{proof:opt_s}
\begin{proof}
...
\end{equation}
If $s_i = 1$, sample $i$ will be classified as anomaly; otherwise, it will be classified as normal.
By the way, \Cref{proof:opt_s} has been proved.
\end{proof}


\subsection{Proof of \Cref{th:gamma_c}}\label{proof:gamma_c}
\begin{proof}
...
\subsection{Proof of \Cref{th:trans}}\label{proof:trans}
\begin{proof}
Let the reference samples belong to batch $k$ and the target samples belong to batch $k^\prime$.
If \Cref{as:pattern} holds, the reference samples $\bm{\zeta}_l$ satisfy:
\begin{equation}
    \begin{cases}
...
\subsection{Proof of \Cref{le:1/nepsilon}}\label{proof:1/nepsilon}
\begin{proof}
