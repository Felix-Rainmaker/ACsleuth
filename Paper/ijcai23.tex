...
Data obtained through different sequencing technologies originates from heterogeneous distributions. 
This dataset shift is commonly denoted as domain bias in computer vision, encompassing categories 
such as style differences, etc. Batch effects also can be construed as a form of domain bias. 
However, most previous studies failed to recognize such common characteristics between these two 
biases and tended to address them independently, which are neither elegant nor efficient.
